...
public class ExperimentalEmotionModel : EmotionModel
{
    ...
    private readonly float touchDecayRate = 0f;
    private readonly float restDecayRate = 0f;
    private readonly float socialDecayRate = 0f;
    private readonly float hungerDecayRate = 0f;
